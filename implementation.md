...
### C++26の機能を有効にする
- Clang 17.0以降は、`-std=c++26`オプションもしくは仮称バージョンの`-std=c++2c`オプションを使用する。
    - GNU拡張を有効にする`-std=gnu++26`および`-std=gnu++2c`オプションもある。
...
### C++26の機能を有効にする
- GCC 14.1以降は、`-std=c++26`オプションもしくは仮称バージョンの`-std=c++2c`オプションを使用する。
    - GNU拡張を有効にする`-std=gnu++26`および`-std=gnu++2c`オプションもある。
...
- 2022 Update 14以降は`/std:c++23preview`オプションを使用する。それ以前は`/std:c++latest`オプションを使用する
