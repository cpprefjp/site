...
|---------------|----------------------------------------|-----------------|------------|-----------------|
| 2019 Update 8 | Visual Studio 2019 バージョン 16.8     | 14.28           | 1928       |        |
| 2019 Update 7 | Visual Studio 2019 バージョン 16.7     | 14.27           | 1927       |        |
...
- 2019以降に実行に実装された機能については、`/std:c++latest`オプションを使用する
