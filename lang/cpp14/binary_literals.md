...
`0b`と`0B`に、機能としての違いはない。数値部分に入力できる数�は`0`と`1`のみである。

C++14段階では、整数を2進数表記で文�列化もしくはストリーム出力するための機能は含まれない。
...
- 数値部分に入力できる数�・文�は`0`と`1`のみである
- 2進数リテラルは、リテラル演算�と組み合わせて使用できる
...
## 関連項目
- [C++14 数値リテラルの桁区切り文�](digit_separators.md)
