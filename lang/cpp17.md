...
- 標準ライブラリの参照をC11に更新
    ...
    - [`<ctime>`](/reference/ctime.md)に、[`TIME_UTC`](/reference/ctime/time_utc.md.nolink)マクロ, [`timespec`](/reference/ctime/timespec.md.nolink)構造体, [`timespec_get()`](/reference/ctime/timespec_get.md.nolink)関数を追加
