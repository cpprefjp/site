# テンプレートテンプレートパラメータにtypename�ーワードの使用を許可
* cpp17[meta cpp]

## 概要
テンプレートパラメータはほとんどの箇所で`class`�ーワードと`typename`�ーワードの両方を使用できたが、テンプレートテンプレートパラメータのクラステンプレート部分については`class`�ーワードしか使用できなかった。
...
C++17では、テンプレートテンプレートパラメータでも`typename`�ーワードを使用できることとなった。
