...
* `文字列リテラル`が与えらた場合、診断メッセージは`文字列リテラル`を含む。それ以外の場合、診断メッセージは未規定
* その他の点は C++11 と同じ
...
* `文字列リテラル`が与えらた場合、診断メッセージは`文字列リテラル`を含む。それ以外の場合、診断メッセージは`定数式`のテキストからなる
* `文字列リテラル`が与えらた場合、診断メッセージは`文字列リテラル`を含む。それ以外の場合、診断メッセージは実装依存
