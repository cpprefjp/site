...
このためクラステンプレートが基底クラスと派生クラスでメンバ関数をオーバー�ードする場合、
実装が煩雑になってしまう問題があった。
...
// クラスを2つ以上受け取る場合、先�のクラス T とそれ以外 Ts に分割する
template <typename T, typename... Ts>
struct ForAll2 : T, ForAll2<Ts...> {
  using T::operator(); // 先�のクラス T の operator() を使えるようにする
