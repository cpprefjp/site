...
- [`std::index_sequence`](/reference/utility/index_sequence.md)クラスを[構造化束縛](/lang/cpp17/structured_bindings.md)と[template for文](/lang/cpp26/expansion_statements.md)で使用できるようにするため、タプルインタフェースの特殊化を追加
