...
- [Visual C++](/implementation.md#visual_cpp): 2013, 2015
	...
	- ターゲットのCPUアー�テクチャが`x86`以外である場合、0と定義されている。
	- ターゲットのCPUアー�テクチャが`x86`で、SSE2を使用する場合（`/arch:SSE2`以上のコンパイラオプション）、0と定義されている。
	- ターゲットのCPUアー�テクチャが`x86`で、SSE2を使用しない場合（`/arch:IA32`や`/arch:SSE`コンパイラオプション）、2と定義されている。
