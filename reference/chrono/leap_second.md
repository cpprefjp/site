...
| `bool operator!=(const leap_second&, const leap_second&) noexcept;`<br/> `template <class Duration>`<br/> `bool operator!=(const leap_second&, const sys_time<Duration>&);` | 非等値比較を行う (`==`により使用可能) | C++20 |
