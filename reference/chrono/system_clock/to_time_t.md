...
[`time_point`](/reference/chrono/time_point.md)の分解能が[`time_t`](/reference/ctime/time_t.md)よりも高い場合は、[`time_t`](/reference/ctime/time_t.md)の分解能に制限される。丸めるか切り捨てるかは処理系定義である。
