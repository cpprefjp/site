...
- (12) : タイムゾーン`z`と`zt`がもつ[`sys_time`](/reference/chrono/sys_time.md)型の時間点を保持する
- (13) : (12)と等価。丸めオプションは使われない
- (14) : 指定した名前のタイムゾーンと、`zt`がもつ[`sys_time`](/reference/chrono/sys_time.md)型の時間点を保持する
- (15) : (14)と等価。丸めオプションは使われない
