...
| 型 | 説明 | 対応バージョン |
|-----------------------------------------------|-------------------------------------------------------|-------|
| `int8_t`                                      | 8ビット幅の符号あり整数(実装するかどうかは処理系定義) | C++11 |
| `int16_t`                                     | 16ビット幅の符号あり整数(実装するかどうかは処理系定義) | C++11 |
| `int32_t`                                     | 32ビット幅の符号あり整数(実装するかどうかは処理系定義) | C++11 |
| `int64_t`                                     | 64ビット幅の符号あり整数(実装するかどうかは処理系定義) | C++11 |
