...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| [`NULL`](/reference/cstddef/null.md) | ヌルポインタ定数に展開されるマク� | |
...
| `SEEK_SET` | ファイルの先�位置を指定するための整数定数 | |
...
| `fsetpos`  | ファイルの現在位置を�定する | |
| `ftell`    | ファイルの現在位置を取得する | |
| `rewind`   | ファイルの現在位置を先�に戻し、エラーや終端判定をクリアする | |
| `clearerr` | エラーをクリアする | |
...
| `getc`    | ストリームから1文�入力する | |
| `getchar` | 標準入力から1文�入力する | |
| `putc`    | ストリームに1文�出力する | |
| `putchar` | 標準出力に1文�出力する | |
| `puts`    | 標準出力に文�列を出力する | |
| `uungetc` | 入力ストリームに1文�戻す | |
...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| `snprintf`  | 書式と文�数を指定して、文�列領域に出力する | |
| `sprintf`   | 書式を指定して文�列領域に出力する | |
| `sscanf`    | 書式を指定して文�列領域から入力する | |
| `vsnprintf` | 可変引数リスト`va_list`を使用し、書式と文�数を指定して、文�列領域に出力する | |
| `vsprintf`  | 可変引数リスト`va_list`を使用し、書式を指定して文�列領域に出力する | |
| `vsscanf`   | 可変引数リスト`va_list`を使用し、書式を指定して文�列領域から入力する | |
...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| `serbuf`  | 入出力用のバッファを�定する | |
| `setvbuf` | 戦略を指定して入出力用のバッファを�定する | |
