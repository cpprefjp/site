...
二重終端キューは、シーケンスの終端または先頭への挿入（もしくは削除）が効率的なパフォーマンスとなるよう、設計されている。他の場所への挿入は通常、<code style='font-size:10pt'>[list](/reference/list.md)</code>コンテナよりも効率の面で劣る。
...
| | |
|---------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| [`emplace`](/reference/deque/emplace.md) | 任意の位置に要素を直接構築で挿入する |
