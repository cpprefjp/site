...
| [`is-integer-like`](iterator/is_integer_like.md)        | 整数型と同等の型か否かを表す (variable template)              | C++20     |
| [`is-signed-integer-like`](iterator/is_integer_like.md) | 符号付き整数型と同等の型か否かを表す (variable template)              | C++20     |
