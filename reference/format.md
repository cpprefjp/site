...
| [`dynamic-format-string`](format/dynamic-format-string.md) | 説明用としての書式の実行時文字列クラス (class template) | C++26 |
| [`dynamic_format`](format/dynamic_format.md) | 書式の実行時文字列を指定するために文字列をラップする (function) | C++26 |
