...
- [LWG Issue 1276. forwardlist missing allocator constructors](https://cplusplus.github.io/LWG/issue1276)
    - C++11で、アロケータを指定するコピーコンストラクタとムーブコンストラクタが追加された。ほかのコンテナには用意されていたが、記載が漏れていた
