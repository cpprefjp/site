...
- 文字 `c` のストリームへの出力 [`fputc`](../../cstdio/fputc.md.nolink)`(f, c);` は `str.`[`rdbuf`](../basic_ios/rdbuf.md.nolink)`()->`[`sputc`](../../streambuf/basic_streambuf/sputc.md.nolink)`(c);` と同等であり、
- 文字 `c` のストリームからの入力 `c = `[`fgetc`](../../cstdio/fgetc.md.nolink)`(f);` は `c = str.`[`rdbuf`](../basic_ios/rdbuf.md.nolink)`()->`[`sbumpc`](../../streambuf/basic_streambuf/sbumpc.md.nolink)`();` と同等であり、
- 文字 `c` のストリームへの戻し [`ungetc`](../../cstdio/ungetc.md.nolink)`(c, f)` は `str.`[`rdbuf`](../basic_ios/rdbuf.md.nolink)`()->`[`sputbackc`](../../streambuf/basic_streambuf/sputbackc.md.nolink)`(c);` と同等である。
