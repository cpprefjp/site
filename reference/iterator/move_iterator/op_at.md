...
`return std::[move](https://sites.google.com/site/cpprefjp/reference/utility/move)([base](https://sites.google.com/site/cpprefjp/reference/iterator/move_iterator/base)()[n]);`
