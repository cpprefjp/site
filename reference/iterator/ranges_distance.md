...
- (2) : 次のいずれかによって、範囲の長さを求める。
    ...
    - それ以外の場合 : `return `[`ranges::distance`](/reference/ranges/distance.md.nolink)`(`[`ranges::begin`](/reference/ranges/begin.md.nolink)`(r), `[`ranges::end`](/reference/ranges/end.md.nolink)`(r))`
