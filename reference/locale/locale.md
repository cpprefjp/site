...
|----------------------|---------------------------------------------------|
| `global` | グ�ーバル�ケールの�定 |
| `classic` | C�ケールを表すオブジェクトの取得 |

### メンバ型

| 名前 | 説明 |
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| `category` | ビットマスク型 `int`。 `locale`が保持するファセットを�別する用途。 |
| [`id`](locale/id.md) | `facet`の�別用のクラス |
...
| `static const category ctype = 0x20;` | 文�分類ファセット |
