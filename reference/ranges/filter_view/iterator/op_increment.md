...
```cpp
constexpr iterator& operator++();                             // (1) C++20
constexpr void operator++(int);                               // (2) C++20

constexpr iterator operator++(int) requires forward_range<V>; // (3) C++20
iterator operator++(int) requires forward_range<V> = default; // (3) C++29
```
