...
- [`lock()`](shared_mutex/lock.md)／[`unlock()`](shared_mutex/unlock.md)メンバ関数：書き込み用の�ックを取得する
- [`lock_shared()`](shared_mutex/lock_shared.md)／[`unlock_shared()`](shared_mutex/unlock_shared.md)メンバ関数：�み込み用の�ックを取得する
...
| `operator=(const shared_mutex&) = delete;`        | 代入演算� | C++17 |
...
| 名前 | 説明 | 対応バージョン |
|-------------------------------------|--------------------------------------------|-------|
| [`lock`](shared_mutex/lock.md)           | 排他�ックを取得する | C++17 |
| [`try_lock`](shared_mutex/try_lock.md)   | 排他�ックの取得を試みる | C++17 |
| [`unlock`](shared_mutex/unlock.md)       | 排他�ックを手放す | C++17 |
...
| 名前 | 説明 | 対応バージョン |
|-------------------------------------|--------------------------------------------|-------|
| [`lock_shared`](shared_mutex/lock_shared.md)           | 共有�ックを取得する | C++17 |
| [`try_lock_shared`](shared_mutex/try_lock_shared.md)   | 共有�ックの取得を試みる | C++17 |
| [`unlock_shared`](shared_mutex/unlock_shared.md)       | 共有�ックを手放す | C++17 |
