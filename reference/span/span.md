...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| [`first`](span/first.md.nolink)     | 先頭N個の要素を参照する`span`オブジェクトを取得する | C++20 |
...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| [`size`](span/size.md.nolink)             | 参照している要素数を取得する           | C++20 |
| [`size_bytes`](span/size_bytes.md.nolink) | 参照しているバイト数を取得する         | C++20 |
| [`empty`](span/empty.md.nolink)           | 参照している範囲が空かどうかを判定する | C++20 |
...
| [`data`](span/data.md.nolink)        | 参照範囲の先頭を指すポインタを取得する | C++20 |
...
| 名前 | 説明 | 対応バージョン |
|------|------|----------------|
| [`begin`](span/begin.md.nolink) | 先頭を指すイテレータを取得する | C++20 |
| [`end`](span/end.md.nolink) | 末尾の次を指すイテレータを取得する | C++20 |
