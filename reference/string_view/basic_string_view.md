...
文字配列型である文字列リテラルに対して、[`std::basic_string`](/reference/string/basic_string.md)クラスが持つような便利なメンバ関数群を使用できる。
...
| [`crend`](basic_string_view/crend.md.nolink)     | 先頭の前を指す読み取り専用逆イテレータを取得する | C++17 |
...
| 名前                                        | 説明                               | 対応バージョン |
|---------------------------------------------|------------------------------------|----------------|
| [`size`](basic_string_view/size.md.nolink)         | 文字列の長さを取得する             | C++17          |
| [`length`](basic_string_view/length.md.nolink)     | 文字列の長さを取得する             | C++17          |
