...
この値は、[`error_code`](/reference/system_error/error_code.md)/[error_condition](/reference/system_error/error_condition.md)に設定する[`generic_category()`](/reference/system_error/generic_category.md)カテゴリのエラー値として使用される。
...
[Unix系errno一覧](http://pinka99.ddo.jp/nanao/work/errno.html)
