...
- [LWG Issue 1019. Make `integral_constant` objects useable in integral-constant-expressions](https://cplusplus.github.io/LWG/issue1019)
    - C++11の策定時に、`value`が`constexpr`となり、`value_type`への変換演算子が追加された。`integral_constant`のオブジェクトを定数式で使用できるようにするため
