...
（<code style='color:black'>allocator_type::max_size</code> を <code style='color:black'>std::[allocator_traits](/site/cpprefjp/reference/memory/allocator_traits)<allocator_type>::max_size</code> 経由ではなく直接使用しているため。）
