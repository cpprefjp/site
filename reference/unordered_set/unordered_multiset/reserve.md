...
##事後条件
[`bucket_count`](./bucket_count.md)`() > `[`size`](./size.md)`() / `[`max_load_factor`](./max_load_factor.md)`()` かつ、[`bucket_count`](./bucket_count.md)`() >= `[`ceil`](/reference/cmath/ceil.md.nolink)`(n / `[`max_load_factor`](./max_load_factor.md)`())`。
