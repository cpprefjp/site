...
<code style='color:black'>[empty](/reference/unordered_set/unordered_set/empty.md)() == true</code>
...
* empty[link /reference/unordered_set/unordered_set/empty.md]
...
<tr style='height:17px'>
<td style='padding:1px 0.5em;vertical-align:baseline'><code style='color:black'>[swap](/reference/unordered_set/unordered_set/swap.md)</code></td>
