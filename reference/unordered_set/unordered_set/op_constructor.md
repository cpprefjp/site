...
explicit unordered_set(size_type n = 実装依�の既定値,
                       const hasher& hf = hasher(),
                       const key_equal& eql = key_equal(),
...
- (1) : バケット数の最低が実装依�の、要素を持たない空の `unordered_set` を構築する。

- (2) : バケット数最低 `n`、ハッシュ関数オブジェクト `hf`、�ー比較用関数オブジェクト `eql`、ア�ケータオブジェクト `a` で、要素を持たない空の `unordered_set` を構築する。

- (1) + (2) : バケット数最低 `n`、ハッシュ関数オブジェクト `hf`、�ー比較用関数オブジェクト `eql`、ア�ケータオブジェクト `a` で、要素を持たない空の `unordered_set` を構築する。
...
- (6) : ハッシュ関数オブジェクト `hasher()`、�ー比較用関数オブジェクト `key_equal()`、ア�ケータオブジェクト `a` で、要素を持たない空の `unordered_set` を構築する。
    構築された `unordered_set` のバケット数、および、[`max_load_factor`](max_load_factor.md)`()` は実装依�である。
...
- (9) : (3) の形式を `unordered_set(il.begin(), il.end(), n, hf, eql, a)` として呼び出した場合と�価である。

- (10) : (2) の形式を `unordered_set(n, hasher(), key_equal(), a)` として呼び出した場合と�価である。

- (11) : (2) の形式を `unordered_set(n, hf, key_equal(), a)` として呼び出した場合と�価である。

- (12) : (3) の形式を `unordered_set(f, l, n, hasher(), key_equal(), a)` として呼び出した場合と�価である。

- (13) : (3) の形式を `unordered_set(f, l, n, hf, key_equal(), a)` として呼び出した場合と�価である。

- (14) : (5) の形式を `unordered_set(il, n, hasher(), key_equal(), a)` として呼び出した場合と�価である。

- (15) : (5) の形式を `unordered_set(il, n, hf, key_equal(), a)` として呼び出した場合と�価である。
...
- (9) : (2) の形式を `unordered_set(il.begin(), il.end(), n, hf, eql, a)` として呼び出した場合と�価。
- (10) : (2) の形式を `unordered_set(n, hasher(), key_equal(), a)` として呼び出した場合と�価。
- (11) : (2) の形式を `unordered_set(n, hf, key_equal(), a)` として呼び出した場合と�価。
- (12) : (3) の形式を `unordered_set(f, l, n, hasher(), key_equal(), a)` として呼び出した場合と�価。
- (13) : (3) の形式を `unordered_set(f, l, n, hf, key_equal(), a)` として呼び出した場合と�価。
- (14) : (5) の形式を `unordered_set(il, n, hasher(), key_equal(), a)` として呼び出した場合と�価。
- (15) : (5) の形式を `unordered_set(il, n, hf, key_equal(), a)` として呼び出した場合と�価。
