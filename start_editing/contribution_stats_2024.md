...
| [commit cpprefjp/site, 4bf3b2a] | cpprefjp/addref:1, cpprefjp/link:2 | `chunk_view` |
...
| [commit cpprefjp/site, 16ab0b8] | cpprefjp/fixl:1 | `view_interface::empty` : LWG Issue 3715対応 |
| [commit cpprefjp/site, 1522cff] | cpprefjp/fixl:1 | Update user-generated_static_assert_messages.md `std::format()`の`constexpr`対応はまだ |
| [commit cpprefjp/site, 7e81584] | cpprefjp/fixm:1 | `nexttoward` : typo修正 |
...
| コミット | タグ | 説明 |
|----------|------|------|
| [commit cpprefjp/site, 1b09fb1, b66dc23] | | 2023年分の貢献ポイントまとめ |
| [commit cpprefjp/site, a38076e, d2f5783, bdfe351] | cpprefjp/fixs:3 | fix: use markdown link, not a url |
| [commit cpprefjp/site, 50d9d18, d436315] | | スポンサー更新 |
| [commit cpprefjp/site, 719017d] | tool/improvem:1 | reference / module以下の階層で、meta headerが指定されなかったらエラーにする |
| [commit cpprefjp/site, 4b9c2df, a877468, 6af4176] | cpprefjp/fixl:5, cpprefjp/link:2 | C++26 : 2023-12 Mailingに対応 |
| [commit cpprefjp/site, 7df12cd] | cpprefjp/fixm:1 | `basic_string::reserve` : 非推奨・削除の詳細用の見出しを設定 |
| [commit cpprefjp/site, c422171] | cpprefjp/link:2, cpprefjp/fixl:1, cpprefjp/addref:1 | C++26対応として、`span::at`を追加 |
| [commit cpprefjp/site, 3bcf3e6] | cpprefjp/fixl:1 | C++26対応として`span`のコンストラクタに`initializer_list`をとるオーバーロードを追加 |
| [commit cpprefjp/site, 617a941] | cpprefjp/fixl:53 | `<cmath>`と`<complex>`の`constexpr`対応 |
| [commit cpprefjp/site, 52a8ab1] | cpprefjp/fixl:5 | C++26対応として`<codecvt>`ライブラリを削除 |
| [commit cpprefjp/site, aa9d684] | cpprefjp/compiler:5 | コンパイラのC++26対応状況を更新 |
| [commit cpprefjp/site, 25162a1] | cpprefjp/fixl:2 | `to_string` / `to_wstring` : C++26対応としてformatベースの仕様に変更 |
| [commit cpprefjp/site, e189708] | cpprefjp/fixl:1 | `basic_ostream::operator<<` : C++23対応として`const volatile void*`のオーバーロードを追加 |
| [commit cpprefjp/site, 8bedbe3] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : `#warning` を追加 |
| [commit cpprefjp/site, 33a231f] | cpprefjp/addlang:1, cpprefjp/link:3 | C++23: 「ラムダ式で`()`を省略できる条件を緩和」を追加 |
| [commit cpprefjp/site, 8ba9fba] | cpprefjp/addlang:1, cpprefjp/link:6 | C++23 : 「ラムダ式に対する属性」を追加 |
| [commit cpprefjp/site, 7e3cbd4, 86e7cee] | cpprefjp/addlang:1, cpprefjp/addref:1, cpprefjp/link:5, cpprefjp/fixl:1 | C++23 : 「thisポインタをもつ必要のない演算子をstaticとして宣言できるようにする」を追加し関連ページを修正 |
| [commit cpprefjp/site, 923f152, cb8f141] | cpprefjp/addref:2, cpprefjp/fixl:2, cpprefjp/fixm:2 | charconv : C++26対応として`from_chars_result` / `to_chars_result`に`operator bool`を追加 |
| [commit cpprefjp/site, 4029cd2] | cpprefjp/addlang:1, cpprefjp/link:3 | C++23 : 「名前付きユニバーサルキャラクタ名」を追加 |
| [commit cpprefjp/site, 1f961de] | cpprefjp/addlang:1, cpprefjp/link:4 | C++23 : 「初期化文での型の別名宣言を許可」を追加 |
| [commit cpprefjp/site, 688d25f, d90163c] | cpprefjp/addlang:1, cpprefjp/link:3 | C++23 : 「エスケープシーケンスの区切り」を追加 |
| [commit cpprefjp/site, 1666a75] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「複合文の末尾へのラベルを許可」を追加 |
| [commit cpprefjp/site, cdd2548] | | スポンサー更新 |
| [commit cpprefjp/site, 8e2ed62] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「1ワイド文字に収まらないワイド文字リテラルを禁止する」を追加 |
| [commit cpprefjp/site, 547e205] | cpprefjp/link:11 | nolinkを解除 |
| [commit cpprefjp/site, b073a03, 8d5b3bf] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「異なる文字エンコーディングをもつ文字列リテラルの連結を不適格とする」を追加 |
| [commit cpprefjp/site, 8f7faa7] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「静的な診断メッセージの文字エンコーディング」を追加 |
| [commit cpprefjp/site, f606137] | cpprefjp/fixm:4 | ライブラリのひな形に、「この機能が必要になった背景・経緯」を追加 |
| [commit cpprefjp/site, 197de33] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「アクセス制御の異なるメンバ変数のレイアウトを宣言順に規定」を追加 |
| [commit cpprefjp/site, 6dbd0b7] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「文字リテラルエンコーディングを一貫させる」を追加 |
| [commit cpprefjp/site, 256984f] | | スポンサー更新 |
| [commit cpprefjp/site, 893d77e] | cpprefjp/addlang:1, cpprefjp/link:3 | C++23 : 「継承コンストラクタからのクラステンプレート引数の推論」を追加 |
| [commit cpprefjp/site, ab80c52] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「elif/elifdef/elifndefのサポートを追加」 |
| [commit cpprefjp/site, 296296a] | cpprefjp/addlang:1, cpprefjp/link:2 | C++23 : 「行末スペースを無視するよう規定」を追加 |
| [commit cpprefjp/site, 45cad45] | cpprefjp/addlang:1, cpprefjp/link:4 | C++23 : 「定数式の文脈でのboolへの縮小変換を許可」を追加 |
...
| [commit cpprefjp/site, 4774e39] | cpprefjp/fixs:3369 | 全体 : 動作確認した処理系に「検証済み」「未実装」の絵文字を入れた |
...
| [commit cpprefjp/site, e9fb3fd, fd2e8e6, e2ee1da] | cpprefjp/addlang:1, cpprefjp/link:4, cpprefjp/fixm:1 | C++26 : 「条件式での構造化束縛の使用を許可」を追加 |
...
| [commit cpprefjp/site, ec423b7] | cpprefjp/addref:2, cpprefjp/fixl:2 | add insert_range to std::map and std::multimap |
...
| コミット | タグ | 説明 |
|----------|------|------|
| [commit cpprefjp/site, 4cbbdae, 9b4c3b8, 0a6aa59, 22a02d4] | cpprefjp/link:5, cpprefjp/addref:6, cpprefjp/fixl:1 | `functional/function_ref` |
| [commit cpprefjp/site, f1173da] | cpprefjp/link:1 | GLOBAL_QUALIFY_LIST: `<print>`ヘッダへのリンク追加 |
| [commit cpprefjp/site, a0280b5, e440100, c7ab072, 3fa6638, 40ff587, 6342d39, dc7da61, 1ddfc8d, d862f0a, c473fc9, f736446, deacb47, c38cacd, 5f397d4, 609bb74, 14b6cb2, 75d3ea3, 8de03aa, b705d4a, 125994a, d2963f0, 4936e04, 5d73471, 7c5eb19, 979afd4, e24da03, 300f467] | cpprefjp/link:5, cpprefjp/addref:80 | `mdspan` |
| [commit cpprefjp/site, 967d060] | cpprefjp/fixl:1 | `basic_string/reserve`: C++26 P2870R3対応 |
| [commit cpprefjp/site, 754290d] | cpprefjp/fixm:7 | 用語統一: 直接非リスト初期化(direct-non-list-initialization) |
| [commit cpprefjp/site, 743eef7] | cpprefjp/fixm:1 | generator: 例示追加 第2テンプレートパラメータV利用 |
| [commit cpprefjp/site, 02d3eac] | cpprefjp/addref:5, cpprefjp/link:2 | numeric: 飽和演算 |
| [commit cpprefjp/site, 284b03c] | cpprefjp/addref:5, cpprefjp/fixl:9 | generator: 説明増補 |
| [commit cpprefjp/site, d3354b9, ea5cfe4, 9f57615, ad3c244, c27c81f, 422aeb5, 2eb18f4, 2079dde, 89ae27b, 0ee79ff] | cpprefjp/addref:18, cpprefjp/link:6 | linalg |
| [commit cpprefjp/site, 5be9a45] | cpprefjp/fixs:1 | cpp11/range_based_for: markup code |
| [commit cpprefjp/site, b6148ac] | cpprefjp/fixl:2 | chrono/last_spec: 説明の表現調整 |
| [commit cpprefjp/site, 5d0c100] | cpprefjp/fixm:1 | layout_blas_packed/mapping: fix markup |
| [commit cpprefjp/site, 17c594a, 417ea30] | cpprefjp/link:3, cpprefjp/fixl:3, cpprefjp/addref:1 | span,mdspan: C++26 P3029R1対応 |
| [commit cpprefjp/site, 2a6ccb4] | cpprefjp/link:2 | fix links to `swappable_with` concept |
| [commit cpprefjp/site, d73c2fc] | cpprefjp/fixm:14 | linalg: refine BLAS1 functions |
| [commit cpprefjp/site, 0ed791c] | cpprefjp/fixl:2 | mdspan/dims: C++26 P2389R2対応 |
| [commit cpprefjp/site, 86cd612] | cpprefjp/fixl:1 | functional/reference_wrapper: LWG3041へ言及 |
| [commit cpprefjp/site, da93e92, 246e875, 01cb107, e88b8d5, 2276b3a, 86c310c, 5c9ff3e, 8c041b3, 110d328] | cpprefjp/addref:25, cpprefjp/fixl:9, cpprefjp/fixm:1 | mdspan: layout_{left,right}_padded概要 P2642R6 |
| [commit cpprefjp/site, 38cc9e4] | cpprefjp/fixm:4 | linalg: 表示崩れを修正 |
| [commit cpprefjp/site, 735b35e] | cpprefjp/addref:4, cpprefjp/link:42, cpprefjp/fixm:1 | linalg: 入出力引数コンセプトの説明追加 |
| [commit cpprefjp/site, 2e1d2fe] | cpprefjp/fixm:2 | chrono: `leap_second_info`例示コード改定(GCC13.2) |
| [commit cpprefjp/site, 022d8d8] | cpprefjp/fixm:1 | chrono/`leap_second`: 例示コード修正(GCC13.2) |
| [commit cpprefjp/site, 072cb24] | cpprefjp/fixm:1 | start_editing: 自動テストの一覧を最新化 |
| [commit cpprefjp/site, 2a47b4b] | cpprefjp/fixm:5 | chrono: `gps_clock`,`gps_time`例示コード調整 |


## [hi-hori](https://github.com/hi-hori)
| コミット | タグ | 説明 |
|----------|------|------|
| [commit cpprefjp/site, 323fd20] | cpprefjp/fixm:1 | `std::ranges::views::all` ページ上部の名前空間表示を `std::ranges` から `std::ranges::views` に修正 |
