...
| [commit cpprefjp/site, f462880, cdd2573, 16242c5, 8113c79] | cpprefjp/fixl:4, cpprefjp/addref:4 | fstream : C++26対応として`native_handle`を追加 (close #1196) |
| [commit cpprefjp/site, cdaf0f7] | cpprefjp/fixs:6 | fstream : サンプルコードのインデントを4 → 2スペースに修正 |
| [commit cpprefjp/site, 3a27b55, fa3dcb5] | cpprefjp/fixm:2 | `basic_ifstream`, `basic_ofstream` : サンプルコードを追加 |
| [commit cpprefjp/site, c3e97ea] | cpprefjp/fixl:1 | `allocator` : C++26対応として`is_always_equal`を削除 (close #1242) |
| [commit cpprefjp/site, 1fe3de6] | cpprefjp/fixl:1 | `projected` : C++26での不完全型への対策に対応 (close #1185) |
| [commit cpprefjp/site, c551d63] | cpprefjp/link:2, cpprefjp/addref:5 | `repeat_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, d3f5ac2] | cpprefjp/fixm:1 | `filter_view` : バージョン指定ミスを修正 #713 |
| [commit cpprefjp/site, cb70d2c] | cpprefjp/fixl:1 | `filter_view` : emptyは継承してた #713 |
| [commit cpprefjp/site, 9df8a06] | cpprefjp/link:1 | グローバル修飾 : `in_place`を登録 |
| [commit cpprefjp/site, eb2177a] | cpprefjp/link:1, cpprefjp/addref:7 | `single_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 2c26002] | cpprefjp/fixl:1 | `empty_view` : 継承しているメンバ関数として不足していたものを追加 #713 |
| [commit cpprefjp/site, 2a23e4d] | cpprefjp/link:1, cpprefjp/addref:5 | `empty_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 38de7a5] | cpprefjp/link:1 | `empty_view` : コード修飾を追加 |
| [commit cpprefjp/site, 9e745c4] | cpprefjp/fixm:1 | `filter_view::iterator` : `value_type`と`difference_type`の説明を追加 #713 |
| [commit cpprefjp/site, b879741] | cpprefjp/link:2, cpprefjp/addref:2 | `filter_view::iterator` : `iter_move`と`iter_swap`を追加 #713 |
| [commit cpprefjp/site, 921ab26] | cpprefjp/link:1, cpprefjp/addref:2 | `filter_view::iterator` : `iterator_category`と`iterator_concept`を追加 #713 |
| [commit cpprefjp/site, d36b13a] | cpprefjp/fixm:1 | `transform_view` : メンバ型の概要だけ追加 #713 |
| [commit cpprefjp/site, 15c75ce] | cpprefjp/link:2, cpprefjp/addref:6 | `transform_view` : メンバ関数を追加 #713 |
...
| [commit cpprefjp/site, fea94ab] | cpprefjp/link:2, cpprefjp/addref:6 | `as_rvalue_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 515f731] | cpprefjp/fixm:1 | `as_rvalue_view` : グローバル修飾が効くように`std::`をつけた #713 |
| [commit cpprefjp/site, d9e860a] | cpprefjp/link:2, cpprefjp/addref:8 | `ref_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 0d8274f] | cpprefjp/link:2, cpprefjp/addref:3 | `basic_istream_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 0c02cf4, 6df87c7, daf9779] | cpprefjp/link:2, cpprefjp/addref:6 | `common_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 3380084] | cpprefjp/fixm:1 | `common_view` : 概要文章がわかりにくかったので平易にした |
| [commit cpprefjp/site, e399f0d] | cpprefjp/fixm:1 | `common_range` : 例を追加 |
| [commit cpprefjp/site, f1ce7b6] | cpprefjp/link:1, cpprefjp/addref:5 | `concat_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 1ab7976] | cpprefjp/link:2, cpprefjp/addref:5 | `split_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 0f03a4a] | cpprefjp/link:2, cpprefjp/addref:5 | `lazy_split_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 30dd29c] | cpprefjp/link:1, cpprefjp/addref:5 | `join_with_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, a5b62f3] | cpprefjp/link:1, cpprefjp/addref:5 | `join_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, ff88ad3] | cpprefjp/link:2, cpprefjp/addref:6 | `drop_while_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 23b7fdf] | cpprefjp/link:1, cpprefjp/addref:6 | `drop_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 85980d0] | cpprefjp/link:1, cpprefjp/addref:6 | `take_while_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, e1744f9] | cpprefjp/link:1, cpprefjp/addref:6 | `take_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 5bd194c, 2f6270f, 197166c] | cpprefjp/link:2, cpprefjp/fixl:1, cpprefjp/addref:7 | `to_input_view` #1423 |
| [commit cpprefjp/site, 0923d23] | cpprefjp/fixm:1 | `as_const_view` : 例のインクルード不足を修正 |
...
| [commit cpprefjp/site, d79c2be] | cpprefjp/link:1, cpprefjp/addref:7 | `stride_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 305a617] | cpprefjp/link:1, cpprefjp/addref:6 | `reverse_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, a878933] | cpprefjp/link:1, cpprefjp/addref:8 | `owning_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 649a2ca] | cpprefjp/link:1, cpprefjp/addref:6 | `enumerate_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 8b59890] | cpprefjp/link:1, cpprefjp/addref:6 | `elements_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 5b1f4d4] | cpprefjp/link:1, cpprefjp/addref:6 | `chunk_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 2c71443] | cpprefjp/link:1, cpprefjp/addref:6 | `chunk_by_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 3aebb6e] | cpprefjp/link:1, cpprefjp/addref:5 | `certesian_product_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 4716074] | cpprefjp/link:1, cpprefjp/addref:6 | `adjacent_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 03cf02b] | cpprefjp/link:1, cpprefjp/addref:6 | `adjacent_transform_view` : メンバ関数を追加 #713 |
| [commit cpprefjp/site, 47a5703] | cpprefjp/fixm:7 | `sstream`: 不足していた例を追加 |
| [commit cpprefjp/site, 3dd6a8e] | | スポンサー更新 #1453 |
| [commit cpprefjp/site, 639c817] | cpprefjp/link:4, cpprefjp/addref:28, cpprefjp/fixm:4 | `sstream` : C++20時点のメンバ関数を追加 |
| [commit cpprefjp/site, 67160f5] | cpprefjp/fixs:1 | `ws` : サンプルコードのインデントを4→2に修正 |
| [commit cpprefjp/site, 0587fce] | cpprefjp/link:1 | リンク切れを修正 #1454 |
| [commit cpprefjp/site, 64398ea, 9ff68ed] | cpprefjp/fixl:8 | `[i|o]stringstream` : C++26 `string_view`の仕様に対応 #1186 |
| [commit cpprefjp/site, b30cc46] | cpprefjp/fixm:4 | `sstream` : 各クラスの概要を補強 |
| [commit cpprefjp/site, 03948a4] | | `ranges::find`, `lower_bound`, `equal_range` : 射影変換の例でコピーを抑止するよう修正 |
| [commit cpprefjp/site, 0844fd3] | tool/improves:1 | NGワードチェック : コード修飾ミスの検出を追加 |
| [commit cpprefjp/site, 30247c1] | cpprefjp/fixm:2 | `ranges::(stable_)partition` : 計算量のコピペミスで実行ポリシーの計算量が記載されてしまっていた問題を修正 #1458 |
| [commit cpprefjp/kunai, 6a74650] | tool/improvem:1 | `position`: stickyをposition: relativeに変更 |
| [commit cpprefjp/kunai, c0bcfce] | tool/improvem:1 | `-webkit-overflow-scrolling`: touchを削除 |
| [commit cpprefjp/kunai, 60a2f66] | tool/improvem:1 | DOM操作の最適化 - 大量要素の一括生成をバッチ処理（5-10要素ずつ）に変更 - 各バッチ間でブラウザに処理時間を与える |
| [commit cpprefjp/kunai, 5dd2bd0] | tool/improvem:1 | メモリリーク修正 - 無限ループの可能性を排除 - タイマーの確実なクリーンアップ - CodeMirrorインスタンスの有効性チェック追加 |
| [commit cpprefjp/kunai, 3146691] | tool/improvem:1 | `file://`プロトコル処理にtry-catchを追加 |
| [commit cpprefjp/kunai, 54530f1] | tool/improvem:1 | tooltipの最適化 - box-shadowを削除し、代わりにborderで視覚効果を維持 - 複雑なtransitionを簡略化（opacity以外のz-index transitionを削除） |
| [commit cpprefjp/kunai, 5d32465] | tool/improvem:1 | サイドバーの最適化 : inset   box-shadowをborderに置き換え |
| [commit cpprefjp/kunai, f52f747] | tool/improvem:1 | layout.css : 大きな要素のbox-shadow無効化 - メインコンテナとヘッダーの大きなbox-shadowを無効化 - GPUメモリを大量に消費する原因となる大きな要素への影の適用 |
| [commit cpprefjp/site, 293579b] | | ライセンスのバージョンを更新 |
| [commit cpprefjp/site, bd7e5a8] | | LICENSEファイルを追加 (CC BY 4.0) |
| [commit cpprefjp/site, 7a4190f] | | スポンサー更新 #1460 |
| [commit cpprefjp/site, 52c95b6] | | スポンサー更新 #1460 |
| [commit cpprefjp/site, 020eed0] | cpprefjp/fixs:1 | `malloc`: 「関連リンク」 → 「関連項目」 |
| [commit cpprefjp/site, a17c2a6] | cpprefjp/fixm:2 | `atof`, `atoi`: C++98からある機能は、コンパイラのバージョン記載はとくになくてよい |
...
| [commit cpprefjp/site, 52363fd] | cpprefjp/fixs:3 | メモリの文脈での「開放」を「解放」に修正 |
| [commit cpprefjp/site, e1018d0] | cpprefjp/fixm:1 | `rand` : 宣言を追加 |
...
| [commit cpprefjp/site, a244c92] | cpprefjp/fixm:14 | `cstdio` : C++のC互換ライブラリの関数はstd名前空間 |
| [commit cpprefjp/site, d1283b6, c9b57c1] | tool/addm:1 | コード修飾の重複を削除するスクリプトを追加 |
| [commit cpprefjp/site, 7bcebc8, 99df1d9, 3d6b7ce, f7a9b45] | cpprefjp/link:906 | 重複登録されたコード修飾リンクを削除 |
| [commit cpprefjp/site, e8c9b48] | cpprefjp/fixm:11 | コード修飾の衝突回避のため`error_condition`型の変数名を`ec` → `econd`に変更 |
| [commit cpprefjp/site, d9b2657] | cpprefjp/fixm:18 | `jthread`の変数名を`t` → `jt`に変更 |
| [commit cpprefjp/site, ec127b7] | cpprefjp/fixm:1 | `realloc` : 備考を整理 |
| [commit cpprefjp/site, 7f39905] | cpprefjp/fixm:1 | `realloc` : インデントのエラーを修正 |
...
| [commit cpprefjp/kunai, 4e72de3] | tool/improvem:1 | iOS 16/17 Safariでのページクラッシュを回避するために相対色のネストをやめた |
| [commit cpprefjp/site, 6b2d865] | cpprefjp/link:6 | 言語機能 : 関連項目を追加 |
| [commit cpprefjp/site, 0712ced] | cpprefjp/fixl:1 | C++26のWorking Draftを更新 #1491 |
| [commit cpprefjp/site, 563f48f] | ignore | プライマリリストのソートがうまく動いてなかったのを修正 |
| [commit cpprefjp/site, 4715e9b] | cpprefjp/fixl:2 | C++26: 2025-08 mailingに対応 (#1497) |
| [commit cpprefjp/site, 8cc1753] | ignore | スポンサー更新 #1524 |
| [commit cpprefjp/site, 07c5ad8] | cpprefjp/link:3 | リンクミスを修正 (close #1526) |
| [commit cpprefjp/site, 0180bdc] | cpprefjp/fixm:1 | `function` : 関数型にパラメータ名を指定することもできることを備考として記載 #1529 |
